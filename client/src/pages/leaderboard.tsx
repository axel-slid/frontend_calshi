...
import { Trophy, ArrowLeft, Search, RefreshCw } from "lucide-react";
        ...
        <div className="flex items-center justify-between gap-3 mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Ranked by credits (tokens).</p>
            </div>
          </div>
        ...
        <Card className="frost noise border-accent/20 p-5 mb-6">
          <div className="flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between">
            ...
            <div className="flex items-center gap-2 text-xs text-muted-foreground uppercase tracking-widest">
              <span>{filtered.length ? `${filtered.length} shown` : "No data"}</span>
        ...
        {leaderboardQuery.isError ? (
          ...
          <Card className="frost noise border-accent/20 p-5">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="text-right">
                        <div className="font-semibold tabular-nums">{formatTokens(u.tokens)}</div>
            ...
            <div className="mt-5 rounded-xl border border-accent/15 bg-accent/5 p-4 text-xs text-muted-foreground">
              Rankings are based on current credit balance (tokens). The leaderboard refreshes automatically.
            </div>
          </Card>
        )}
      </motion.div>
